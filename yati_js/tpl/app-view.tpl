<section id="yati-app" kb-inject="yati.views.AppView">
  ...
  <section data-bind="css: {hide: !(view() == 'index' || view() == 'project' || view() == 'project_users' || view() == 'project_users_lang' || view() == 'project_users_add')}, template: {name: 'index-view', data: $root}"></section>
